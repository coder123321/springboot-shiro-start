package com.sh.config.cache;

import com.sh.common.JwtConstant;
import com.sh.common.RedisConstant;
...
public class CustomCache<K, V> implements Cache<K, V> {
    ...
    private String getKey(Object key) {
        return RedisConstant.PREFIX_SHIRO_CACHE + JwtUtil.getClaim(key.toString(), "id");
    }
